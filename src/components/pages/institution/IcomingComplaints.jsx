...
const IncomingComplaints = () => {
  ...
  const fetchComplaints = async () => {
    try {
      ...
      const params = {
        ...
        assignedTo: true, // Only get complaints assigned to this institution
        ...filters,
      }
  ...
  return (
    <PageContainer>
      <PageHeader>
        <PageTitle>Incoming Complaints</PageTitle>
      </PageHeader>
            ...
            <TableBody>
              {complaints.map((complaint) => (
                <tr key={complaint._id}>
                  ...
                  <td>
                    <ViewButton to={`/institution/respond/${complaint._id}`}>Respond</ViewButton>
                  </td>
                </tr>
              ))}
            </TableBody>
